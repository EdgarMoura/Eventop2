...
@NamedQueries({
    ...
    @NamedQuery(name = "Endereco.findByCapacidade", query = "SELECT e FROM Endereco e WHERE e.capacidade = :capacidade"),
    @NamedQuery(name = "Endereco.findByValor", query = "SELECT e FROM Endereco e WHERE e.valor = :valor"),
...
public class Endereco implements Serializable {
    ...
    @JoinColumn(name = "ID_ENDERECO", referencedColumnName = "ID_ORCAMENTO", insertable = false, updatable = false)
